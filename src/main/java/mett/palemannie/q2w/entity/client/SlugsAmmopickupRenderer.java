...
public class SlugsAmmopickupRenderer extends EntityRenderer<SlugsAmmopickupEntity, EntityRenderState> {

    private static final Identifier SLUGSPICKUP_LOCATION = Identifier.fromNamespaceAndPath(Quake2Weapons.MODID,"textures/entity/itempickups/slugs_ammopickup.png");
    private final SlugsAmmopickupModel model;
