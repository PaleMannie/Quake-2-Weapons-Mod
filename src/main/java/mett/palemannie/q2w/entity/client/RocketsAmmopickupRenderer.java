...
public class RocketsAmmopickupRenderer extends EntityRenderer<RocketsAmmopickupEntity> {
    ...
    private static final ResourceLocation BULLETPICKUP_LOCATION = ResourceLocation.fromNamespaceAndPath(Quake2Weapons.MODID,"textures/entity/itempickups/rockets_ammopickup.png");
    ...
    public void render(RocketsAmmopickupEntity rocketEntity, float v1, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull RocketsAmmopickupEntity spit) { return BULLETPICKUP_LOCATION; }
