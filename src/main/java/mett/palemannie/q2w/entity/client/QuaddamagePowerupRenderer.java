...
public class QuaddamagePowerupRenderer extends EntityRenderer<QuadDamagePowerupEntity> {
    ...
    private static final ResourceLocation QUAD_LOCATION = ResourceLocation.fromNamespaceAndPath(Quake2Weapons.MODID,"textures/entity/quad_damage_powerup/quad_damage_powerup.png");
