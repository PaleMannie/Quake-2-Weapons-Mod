...
public class GrenadesAmmopickupRenderer extends EntityRenderer<GrenadesAmmopickupEntity, EntityRenderState> {
    ...
    private static final Identifier GRENADESPICKUP_LOCATION = Identifier.fromNamespaceAndPath(Quake2Weapons.MODID,"textures/entity/itempickups/grenades_ammopickup.png");
    ...
    public void submit(EntityRenderState state, PoseStack poseStack, SubmitNodeCollector nodeCollector, CameraRenderState cameraState) {
        ...
        nodeCollector.submitModel(this.model, state, poseStack, this.model.renderType(GRENADESPICKUP_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
