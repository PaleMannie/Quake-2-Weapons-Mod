...
public class EnvirosuitPowerupRenderer extends EntityRenderer<EnvirosuitPowerupEntity, EntityRenderState> {

    private static final Identifier ENVIROSUIT_LOCATION = Identifier.fromNamespaceAndPath(Quake2Weapons.MODID,"textures/entity/powerups/envirosuit_powerup.png");
    private final EnvirosuitPowerupModel model;
    ...
    public void submit(EntityRenderState state, PoseStack poseStack, SubmitNodeCollector nodeCollector, CameraRenderState cameraState) {
        ...
        nodeCollector.submitModel(this.model, state, poseStack, this.model.renderType(ENVIROSUIT_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);

        nodeCollector.submitModel(this.model, state, poseStack, RenderTypes.eyes(ENVIROSUIT_LOCATION), state.lightCoords, OverlayTexture.NO_OVERLAY, state.outlineColor, null);
