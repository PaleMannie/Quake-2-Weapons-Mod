...
public class GrenadelauncherProjectileEntity extends Projectile {
    ...
    private void quakeExplosion(Level level) {
        ...
        AABB area = new AABB(this.blockPosition()).inflate(Q2WConfigStats.GrenadelauncherRadius);
        ...
        QWExplosionHelper.grenadeLauncherExplosion(serverLevel, this, this.getOwner(), center, this.getOwner());
