...
public class AdrenalineItem extends AbstractConsumptionItem{
    ...
    protected void onPowerupUse(Level level, Player player, ItemStack stack) {
        ...
        MobEffectInstance currentHealthBoost = player.getEffect(ModEffects.ADRENALINE_HEALTH_BOOST.get());
        ...
        player.addEffect(new MobEffectInstance(ModEffects.ADRENALINE_HEALTH_BOOST.get(),
