...
public class ModelLayerRegistry {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(RebreatherPickupModel.REBREATHERPICKUP_LAYER, RebreatherPickupModel::createBodyLayer);
        event.registerLayerDefinition(PowershieldPickupModel.POWERSHIELDPICKUP_LAYER, PowershieldPickupModel::createBodyLayer);
    }
}